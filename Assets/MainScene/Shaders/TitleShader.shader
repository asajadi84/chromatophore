...
Shader "Shadero Customs/TitleShader"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
LiquidUV_WaveX_1("LiquidUV_WaveX_1", Range(0, 2)) = 0.321
LiquidUV_WaveY_1("LiquidUV_WaveY_1", Range(0, 2)) = 0.357
...
float4 _Hologram_1 = Hologram(LiquidUV_1,_MainTex,_Hologram_Value_1,_Hologram_Speed_1);
